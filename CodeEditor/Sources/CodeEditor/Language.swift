...
public extension CodeEditor.Language {
    ...
    static var cLang        = CodeEditor.Language(rawValue: "c")
    static var cpp          = CodeEditor.Language(rawValue: "cpp")
    static var csLang       = CodeEditor.Language(rawValue: "cs")
    ...
    static var goLang       = CodeEditor.Language(rawValue: "go")
    ...
    static var ocaml        = CodeEditor.Language(rawValue: "ocaml")
