...
We use [Sphinx] for creating the Themis documentation using [reStructuredText] (RST). This documentation is taken and adapted from the Artemis documentation build.
